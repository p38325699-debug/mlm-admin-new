 ...
 */
export declare function matrixSetSubMatrix(matrix: DoubleMatrix, subMatrix: DoubleMatrix, startRow: number, startColumn: number): DoubleMatrix;
//# sourceMappingURL=matrixSetSubMatrix.d.ts.map